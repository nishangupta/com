      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group w-50">
            ...
            <select name="qualification" id="qualification" value="3" class="form-control">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" placeholder="gpa" name="intermediate_gpa" value="{{old('intermediate_gpa')}}" class="form-control">
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-group">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for="">Percentage/Grade/GPA:</label>
                      <input type="text" placeholder="gpa" name="bachelor_gpa"  class="form-control">
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-group">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <label for="">Percentage/Grade/GPA:</label>
                      <input type="text" placeholder="gpa" name="master_gpa" class="form-control">
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-group">
